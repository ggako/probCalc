...
st.set_page_config(page_title='Floor Expected Ceiling', page_icon='images/mountain_icon.png', layout="centered", initial_sidebar_state="expanded", menu_items=None)
